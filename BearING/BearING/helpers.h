 ...
 */
bool ends_with_double_consonant(std::string input_string);
 ...
 * start of _str_.
 *
 * input: input_string: The string from which to count the number of
 ...
 *
 * input: input_string: The string to test for a consonant, vowel,
 *        consonant ending.
 ...
 *         false.
 */
bool ends_with_cvc(std::string input_string);
 ...
 *
 * input: input_string: The string to test for containing a vowel.
